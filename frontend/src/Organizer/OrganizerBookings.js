...
const OrganizerBookings = ({ currentUser }) => {
  ...
  // Fetch bookings for organizer's events only
  useEffect(() => {
    fetchBookings();
  ...
  try {
    setLoading(true);
    setError("");
    // ✅ Updated to use organizer-specific endpoint
  ...
  try {
    // ✅ Updated to use organizer-specific update endpoint
  ...
  return (
    <div className="bookings-container">
      ...
      <div className="bookings-header">
        ...
        <p style={{ fontSize: '0.9rem', color: '#666' }}>Bookings for your events only</p>
      </div>
      ...
      {loading ? (
        ...
        <p className="no-data">No bookings found for your events.</p>
